...
import { requireAuth, requireAdmin, requireVotante, requireEstudiante } from '../middleware/auth.js';
...
router.get('/resultados/:votacionId/estudiante', requireAuth, requireEstudiante, ctrl.resultadosEstudiante);
